...
import { buildSceneOrchestrationDirective, deriveSceneOrchestrationPlan, sceneOrchestrationActionFrame } from '../../lib/scene-orchestration.js';
...
function buildInput(incoming,originalInput,profile,routed,mode='game'){
  ...
  const orchestration=deriveSceneOrchestrationPlan({action,saveState:incoming.saveState||{},mode,directorTelemetry:routed.directorV2?.telemetry});
