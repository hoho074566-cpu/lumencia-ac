...
import { buildSetupPayoffDirective, deriveSetupPayoffPlan } from '../../lib/setup-payoff-memory.js';
...
function buildInput(incoming,originalInput,profile,routed,mode='game'){
  ...
  return{text:composeRoutedInput({saveState,optionalContext,reservedContext,authorityTail,actionBlock,inputChars:profile.inputChars}),orchestration,activeThreads,setupPayoff};
}
