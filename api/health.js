export default async function handler(req, res) {
  res.status(200).json({
    ...
    relationshipThresholds: 'V1 model-semantic trust/hostility transition receipt + canonical eligibility/hysteresis/freeze bounds + existing relationship state only',
