export default async function handler(req, res) {
  res.status(200).json({
    ...
    livingWorldConsequences: 'P2-PR07 bounded presence/NPC conflict/off-screen priority/public consequence/setup-payoff/fail-forward orchestration over existing roots',
