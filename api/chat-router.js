...
function applySceneMomentumTimeFloor(incoming,turn,mode='game',consequenceLifecycle=null,consequenceVisibleScene=[],runtimeAuthority={}){
  ...
  return{...intent,runtimeSceneTrusted:appliedDecisionBoundary&&!untrustedStructuredDecision||unverifiedStructuredScheduleBoundary&&visibleBoundary||preserveSurfacedScheduleScene||raisedFloorSceneRuntimeTrusted||!returnedSceneReconciled,runtimeTrustedConsequenceScene,returnedSceneReconciled,reconciliationReason:returnedSceneReconciled?reconciliationReason:null,structuredBoundaryReconciliationApplied,completedPrefixActionTypes};
}
