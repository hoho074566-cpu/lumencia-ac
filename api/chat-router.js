...
function prefixNpcStateUpdate(row,segments=[]){
  ...
  for(const field of supported){const value=source[field];if(value==null||value===''||value===false)continue;if(consequenceEffectMatches(value,segments))kept[field]=value;}
