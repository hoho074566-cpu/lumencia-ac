...
function applySceneMomentumTimeFloor(incoming,turn,mode='game',consequenceLifecycle=null,consequenceVisibleScene=[],runtimeAuthority={}){
  ...
  const runtimeChoicesTrusted=Boolean(hasMeaningfulStop&&array(turn.choices).length&&(appliedDecisionBoundary||unverifiedStructuredScheduleBoundary||preserveAttributedConsequence&&appliedConsequenceTimeBoundary));
