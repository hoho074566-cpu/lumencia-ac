...
assert.doesNotMatch(routed.params.input,/PERSONAL STORY HOOKS|PC_ORIGIN_PLOT|candidate_count|activation_hint/,'personal-story candidates and activation recipes must stay internal');
assert.equal(routed.telemetry.personal_story_v1?.candidate_count,3,'personal-story state may remain internal telemetry');
