...
assert.match(app, /next\.creation = normalizeCharacterCreation\(next\.creation,\{allowedNpcKeys:Object\.keys\(ASSETS\.characters\|\|\{\}\)\}\)/, 'load normalization preserves additive compatibility and canonical Fate Affinity membership');
