...
assert.doesNotMatch(routed.params.instructions, /NPC는 현재 행동을 자기 기억·기존 판단·목표·관계·지식과 비교|내부 감정은 대사 원문이 아니다/);
...
assert.doesNotMatch(routed.params.input, /state_delta\.memories_add|세 번째로 충분히 일관된 증거/);
