...
assert.match(runtime,/materializeEventConsequencesStable\(data\.turn, data\.pipeline\)/,'delayed consequences must materialize before canonical applyDelta persists hooks');
