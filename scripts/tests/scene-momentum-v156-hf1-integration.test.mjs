...
assert.match(chat,/exit_condition:exitCondition,momentum,scene_delta:sceneDelta/);
assert.match(chat,/scene_momentum_v1:true/);
assert.match(chat,/purpose,exit_condition:exitCondition,momentum,scene_delta:sceneDelta/);
