...
assert.match(chat,/exit_condition:exitCondition,turn_hook:turnHook,goal_tick:goalTick,momentum,novelty,scene_delta:sceneDelta/);
assert.match(chat,/scene_momentum_v1:true/);
assert.match(chat,/purpose,exit_condition:exitCondition,turn_hook:turnHook,goal_tick:goalTick,momentum,novelty,scene_delta:sceneDelta/);
