...
assert.doesNotMatch(context,/buildSceneNoveltyDirective/,'novelty directive must not enter the Writer router');
...
assert.doesNotMatch(context,/DETERMINISTIC SCENE NOVELTY V1/,'novelty machinery must remain internal telemetry/state');
