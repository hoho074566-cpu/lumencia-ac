...
const directorEventId='director:warehouse-fire',directorMetadata={intervention:'event',beat:'warehouse-fire',event_kind:'danger',spotlight_keys:['artemis'],callback_key:null,callback_phase:'none',callback_note:null,reason:'창고 화재가 발생했다'};
