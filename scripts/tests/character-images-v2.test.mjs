...
assert.match(serviceWorker, /['"]\/lib\/fate-book\.js['"]/, 'offline shell must cache the Fate Book dependency');
assert.match(serviceWorker, /lumensia-shell-v11-fate-book-v1/, 'offline shell cache version must invalidate the previous precache');
