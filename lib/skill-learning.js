...
function hasAffirmativeLearningEvidence(value, max, evidencePattern = LEARNING_EVIDENCE_RE) {
...
function hasLearningEvidence({ action = '', scene = [] } = {}) {
  ...
  return supportedIntent && hasAffirmativeLearningEvidence(sceneText, 21_600, LEARNING_SPECIFIC_SCENE_RE);
}
