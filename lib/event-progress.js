...
export function mergeEventProgress(previousValue, incomingValue, { allowInstanceChange = true } = {}) {
  ...
  return { eventInstanceId:previous.eventInstanceId, activeBeat, completedBeats:compactCompleted, completionFingerprint, omittedCompletedCount, resumeKey:previous.resumeKey };
}
