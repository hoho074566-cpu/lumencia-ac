...
import { deriveStructuredExecutionPlan, deriveStructuredTimingCandidate, parseTimePlan } from './time-plan-parser.js';
...
export function classifySceneIntent(action='', { location='', currentTime='', currentDate='', currentWeekday='', actorName='', resumeTimedAction=null } = {}) {
  ...
  let structuredTimePlan=null,structuredTiming={eligible:false},structuredExecution={eligible:false};try{structuredTimePlan=parseTimePlan(text,{location,currentTime,currentDate,currentWeekday,actorName});structuredTiming=deriveStructuredTimingCandidate(structuredTimePlan);structuredExecution=deriveStructuredExecutionPlan(structuredTimePlan);}catch{}
