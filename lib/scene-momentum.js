...
const NATIVE_DAY_DURATION = String.raw`(?:하루|이틀|사흘|나흘|닷새|엿새|이레|여드레|아흐레|열흘|보름)`;
...
function durationExpressionMinutes(text='') {
  ...
  if(namedDayMatch){const days={하루:1,이틀:2,사흘:3,나흘:4,닷새:5,엿새:6,이레:7,여드레:8,아흐레:9,열흘:10,보름:15}[namedDayMatch[1]];return days*1440+(namedDayMatch[2]?720:0);}
