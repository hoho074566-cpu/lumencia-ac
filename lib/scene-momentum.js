...
export function classifySceneIntent(action='', { location='', currentTime='', actorName='' } = {}) {
  ...
  const selectedActivityScope=activityDurationScope(text),clockIntervalTiming=schedulableActivity?parseExplicitClockIntervalTiming(text,currentTime):null,dateQualifiedStart=Boolean(schedulableActivity&&!clockIntervalTiming?.deadline&&selectedActivityDateIsFuture(selectedActivityScope)),clockIntervalMinutes=clockIntervalTiming?.minutes??null;
