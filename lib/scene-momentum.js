...
import { deriveStructuredTimingCandidate, parseTimePlan } from './time-plan-parser.js';
...
export function classifySceneIntent(action='', { location='', currentTime='', currentDate='', currentWeekday='', actorName='', resumeTimedAction=null } = {}) {
  ...
  let structuredTiming={eligible:false};try{structuredTiming=deriveStructuredTimingCandidate(parseTimePlan(text,{location,currentTime,currentDate,currentWeekday,actorName}));}catch{}
