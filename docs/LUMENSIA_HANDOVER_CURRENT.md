...
4. Complete the final clean-LF full PR check and second review, commit this docs checkpoint, push the exact head, and open a protected-path human-merge PR.
