...
4. Focused/full regression and substantive second review pass. Commit/push the second P1 closure and this docs checkpoint, then require the new exact HEAD's Vercel and fresh direct P0/P1=0 review. If any P0/P1 remains, the Codex-local two-remediation cap requires person/trusted-path handoff with the gate still failed; if zero, continue Preview immediately.
