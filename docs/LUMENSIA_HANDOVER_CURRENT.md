...
4. Commit/push the explicit-unowned expiry hardening after correction `171cef1a5f302c63e74bcdff55bed65a9f6a6f3b`, then require exact-current-HEAD Vercel and another fresh direct P0/P1=0 review. Any new P0/P1 starts the next correction immediately; cycle counts and reports are not stop conditions. Repeated narration/wording/effect-attribution findings must be fixed through clause/effect ownership, not new wording regexes.
