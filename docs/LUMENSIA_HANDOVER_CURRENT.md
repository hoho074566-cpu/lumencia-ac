...
9. Commit/push the PR #59 P2 correction and docs checkpoint, verify the new exact head keeps base/merge-base `9458633a...`, behind 0, no conflict, and Vercel PASS, then request a fresh direct exact-head review. If the exact head remains P0/P1=0 with no blocking P2, select the next legacy target from a fresh read-only inventory.
