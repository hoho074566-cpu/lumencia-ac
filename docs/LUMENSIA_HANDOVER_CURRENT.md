...
- **CURRENT MERGE GATE:** STAB-01 **MERGED / POST-MERGE PASS**. STAB-02 / PR #83 is **BLOCKED / DO NOT MERGE**. Closing the concurrent validation-through-persistence race requires a cross-tab transaction coordinator or equivalent serialization. That is a second same-root correction after budget `1/1`; no further implementation, merge, or final Phase 2 life-loop integration is authorized in this pass. Protected paths also remain human-only.
- **NEXT ACTION:** require explicit human direction for a new bounded STAB-02 stabilization attempt that serializes only the inheritance purchase transaction, or leave PR #83 unmerged. Do not use a generic meta-state engine, and keep PR #76/#79 plus every other deferred branch and STAB-01 P2 backlog untouched.
...
2. Continue STAB-02 only on `codex/stab-02-inheritance-next-life-runtime`, based directly on that latest main. Implement the bounded Inheritance / Next Life contract and use STAB-01 first-discovery rewards as its sole canonical earned-point source.
3. Validate stale-save monotonicity, duplicate-reward immunity, Stats/Talents/Resources allocation, progressive costs, Fate Affinity, Origin reroll/lock compatibility, direct Realm/Circle purchase rejection, final recalculation, Next Life application, free/paste creation, and authority/context regressions.
4. Keep PR #76/#79 frozen and unused; keep PR #66/#68/#69/#78 and obsolete/superseded PR #72 untouched. Keep browser on the established bounded fallback.

---

# NEW CHAT START INSTRUCTION

> Read both progress documents first. PR #82 STAB-01 is merged as latest main `89fbc5b94d74a3e1927615993e5c7da88b84a4ff` from exact READY head `d589f7939a1296d966eeb46fc7c5174f8b9a00a2`; merged/reviewed tree and post-merge focused/full/integrity checks PASS. STAB-02 is active on `codex/stab-02-inheritance-next-life-runtime`, created directly from that main. Implement only the bounded Inheritance / Next Life runtime, then run its gates. PR #76/#79 remain frozen and unused; PR #66/#68/#69/#78 and obsolete/superseded #72 remain untouched.
