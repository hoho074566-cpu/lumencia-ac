...
9. Commit/push remediation `16307a3...` and this docs checkpoint. Verify the resulting exact head keeps base=merge-base `9458633a...`, behind 0, no conflict, and Vercel PASS, then request a fresh direct exact-head review. Continue any P0/P1 or player-sovereignty P2 within the remaining remediation of this task; do not merge PR #59 or select the next cleanup target until the current exact head is clear.
