...
- Thin Scene Packet marker/registry failure is fail-closed as `409 WRITER_CONTEXT_UNAVAILABLE` before the model call; the legacy full Writer prompt is never restored as a fallback.
