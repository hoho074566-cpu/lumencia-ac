...
4. Track PR #56 on `codex/time-plan-parser-phase2` from code checkpoint `1ce3f140...`; require its final docs exact HEAD to retain Vercel, mergeability/current-stack, and fresh exact-head P0/P1=0. The main-only Safety signal remains pending until stack resolution; Codex must not merge protected paths.
