...
- PR #51 is open from `codex/combat-growth-v2`. Current code/test checkpoint: `717e85c3637034de96c5c870b063ee07f7e1b615`; initial implementation head was `5866bced8963e2dcdd70c0899c3717dddb6a3b88`.
...
- Dedicated Combat Growth plus affected Skill Learning, Awakening, Scene Momentum, Orchestration, Context Router, CONTINUE, core, debug, and save suites pass. Structural correction code checkpoint `717e85c...` also passes the authoritative dependency-free clean-LF full repository check.
...
- Current code/test checkpoint: `717e85c3637034de96c5c870b063ee07f7e1b615` on `codex/combat-growth-v2`, based directly on the verified PR #50 merge. PR #51 is open and unmerged; confirm the live branch tip before any hosted decision because a docs-only checkpoint follows this code commit.
...
- `scripts/tests/combat-growth-v2.test.mjs` plus all affected growth/router/momentum/orchestration/continue/core/debug/save suites pass. Code checkpoint `717e85c...` also passes `git diff --check` and the dependency-free authoritative clean-LF full PR check.
...
- The user-authorized P0/P1 correction allowance applies: up to five exact-head correction cycles for a new controllable issue type. Stop only for repeated same-type recurrence, cross-core expansion, canon/player-sovereignty/one-call/stable-routing impact, five exhausted cycles, or conflicting unsafe guidance. Current count for this PR is **3/5**; `57085b0...` covered exact imperative wording, `451679f...` covered one adjacent natural narration form, and explicit-resume correction `717e85c...` replaces success-word enumeration with the bounded structural predicate while preserving named-NPC rejection.
- Current blocker is no longer local implementation: correction 3/5 passes focused/full regression. Pending work is the new exact-head Safety/Vercel/fresh Codex authority cycle and Exact Preview confirmation that the failed live structure now produces bounded growth.
...
3. Continue PR #51 from structural correction code checkpoint `717e85c3637034de96c5c870b063ee07f7e1b615`; confirm the docs checkpoint branch tip is newer.
4. Require new-exact-head GitHub Safety, Vercel Ready, and a fresh Codex review. Revalidate main, merge-base, no conflict, one canonical core call, stable routing ceiling, and no migration/new endpoint/canonical-core edit.
5. On the Exact Preview, rerun a fresh deliberate failure→instructor guidance→applied final repetition/cause case and confirm bounded growth. Then verify NPC-only/question-only and META/AUTO/CONTINUE remain frozen. Do not extract a protection token or bypass Preview protection.
