...
- Dedicated and affected Context Router, authority-tail, Scene Momentum, and Event Consequence suites pass after the closure. The authoritative clean-LF full `scripts/lumensia-pr-check.mjs origin/main HEAD` passed at `0cd75a7` and must be rerun on the final docs head.
