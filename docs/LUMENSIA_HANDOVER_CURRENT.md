...
9. Commit/push the single-action cleanup docs checkpoint, open a new stacked protected PR against `codex/time-plan-parser-phase4`, verify exact base/merge-base/behind/conflict and Vercel, then request a fresh direct exact-head P0/P1 review. If the exact head remains P0/P1=0, select the next legacy target from a fresh read-only inventory.
