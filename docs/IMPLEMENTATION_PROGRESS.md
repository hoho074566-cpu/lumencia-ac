...
- Adaptive Time Scale V2 code/test checkpoint: `ed5d2b08d46b2ddd9e2ab9289d25f5b65136b455`.
...
- Focused/affected suites and the authoritative clean-LF full repository regression pass at `ed5d2b0...`; the ordinary Windows worktree reproduces only the known CRLF workflow-fixture artifact.
...
## NEXT ACTION
1. Commit this docs checkpoint on code `4a2533a7a08d7b3e7348e02ae21e7011d0f6a089`, push PR #54, and confirm the new exact head is current against main `1018d8c...`.
2. Require the new exact-head GitHub Safety Gate, Vercel Ready, Merge Readiness/current mergeability, and a fresh exact-head Codex review with P0/P1=0; rerun the clean-LF full regression if the head changes.
3. On the new Exact Preview, rerun the failed schedule-boundary case and plain/compound sleep first. If green, rerun the full dialogue/meal/training/class/sleep/travel, explicit duration, direct-question, historical-reference, and META/AUTO/CONTINUE matrix.
...
- Current candidate: Adaptive Time Scale V2 in PR #54 on `codex/adaptive-time-scale-v2`; code checkpoint `4a2533a...` closes the live time-normalization issues and prior-head duration-order P1, with focused/affected and authoritative clean-LF full regression passing. Docs checkpoint/push, new exact-head hosted authority/fresh review, affected-first rerun, and full Exact Preview acceptance remain.
