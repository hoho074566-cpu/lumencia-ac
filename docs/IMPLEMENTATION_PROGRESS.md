...
- Current local remediation: deterministic meaningful-choice filter, direct-question priority, AUTO hook persistence, strict request syntax, and dynamic authority-tail budgeting regressions pass; clean-LF full rerun, commit/push, fresh hosted gates/review, and affected Preview rerun remain.
